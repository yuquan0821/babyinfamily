...
{
    StatusCoreDataItem *statusItem = (StatusCoreDataItem *)[NSEntityDescription insertNewObjectForEntityForName:@"StatusCoreDataItem" inManagedObjectContext:_managedObjContext];
    
    if (sts.retweetedStatus) {
        statusItem.retweetedStatus = (StatusCoreDataItem *)[NSEntityDescription insertNewObjectForEntityForName:@"StatusCoreDataItem" inManagedObjectContext:_managedObjContext];
...
{
    NSFetchRequest *fetch = [[NSFetchRequest alloc]init];
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"StatusCoreDataItem" inManagedObjectContext:_managedObjContext];
