//
//  BabyAddCommentViewController.m
//  BabyinFamily
//
...
@interface BabyAddCommentViewController ()

@end

@implementation BabyAddCommentViewController
@synthesize textView;
@synthesize toolBar;
@synthesize status;
...
- (void)viewDidLoad
{
    ...
    [self.textView setPlaceholderText:@"分享你的评论吧。。。"];
