...
- (StatusCoreDataItem*)updateStatusCDItem:(StatusCoreDataItem*)sts index:(int)theIndex isHomeLine:(BOOL) isHome
{
    ...
    sts.user = (UserCoreDataItem *)[NSEntityDescription insertNewObjectForEntityForName:@"UserCoreDataItem" inManagedObjectContext:[CoreDataManager getInstance].managedObjContext];
